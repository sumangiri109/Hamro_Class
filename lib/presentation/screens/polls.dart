...
class _PollsPageState extends State<PollsPage> {
  ...
  final List<String> polls = [
    'Should we have a class picnic?',
    'Do you prefer online or offline classes?',
    'Vote for the upcoming seminar topic.',
    'Best time for extra classes?',
  ];
                    ...
                    child: MouseRegion(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color.fromARGB(255, 228, 208, 239),
